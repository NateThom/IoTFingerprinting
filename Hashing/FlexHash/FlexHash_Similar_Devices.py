            ...
            for combo in combo_params:
                for device in device_list:
                    for c_uc in c_uc_list:
                        ...
                        file_list = [
                            f"{path_to_outer_directory}{device}/{'per_packet_no_activity' + c_uc}/{i}"
                            for i in file_list
                        ]
                        ...
                        output_df.to_csv(
                            f"{path_to_output}{device.split('-')[0]}{c_uc}/{device}_{accum}_{window}_{combo}.csv",
                            index=False,
                        )
